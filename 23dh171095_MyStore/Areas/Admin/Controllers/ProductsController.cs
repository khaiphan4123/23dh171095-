...
namespace _23dh171095_MyStore.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Index(string SearchTerm, decimal? minPrice, decimal? maxPrice, string sortOrder,int? page)
        {
            ...
            model.Products = products.ToList().ToPagedList(pageNumber, pageSize);

            // DÒNG DUY NHẤT ĐÃ ĐƯỢC SỬA: Thay vì truyền List<Product>, truyền đối tượng ViewModel.
            return View(model);
        }
